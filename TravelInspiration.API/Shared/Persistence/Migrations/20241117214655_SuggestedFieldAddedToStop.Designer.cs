...
namespace TravelInspiration.Api.Shared.Persistence.Migrations
{
    ...
    [Migration("20241117214655_SuggestedFieldAddedToStop")]
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 11, 17, 21, 46, 55, 275, DateTimeKind.Utc).AddTicks(1560),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 11, 17, 21, 46, 55, 275, DateTimeKind.Utc).AddTicks(1562),
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Stop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 11, 17, 21, 46, 55, 275, DateTimeKind.Utc).AddTicks(1726),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 11, 17, 21, 46, 55, 275, DateTimeKind.Utc).AddTicks(1731),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 11, 17, 21, 46, 55, 275, DateTimeKind.Utc).AddTicks(1736),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 11, 17, 21, 46, 55, 275, DateTimeKind.Utc).AddTicks(1740),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 11, 17, 21, 46, 55, 275, DateTimeKind.Utc).AddTicks(1744),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 11, 17, 21, 46, 55, 275, DateTimeKind.Utc).AddTicks(1747),
